...
qBool ALSnd_Init (void)
{
	...
	qalEnable					= (LPALENABLE)(void*)AL_GPA("alEnable");
	qalDisable					= (LPALDISABLE)(void*)AL_GPA ("alDisable");
	qalIsEnabled				= (LPALISENABLED)(void*)AL_GPA ("alIsEnabled");

	qalGetString				= (LPALGETSTRING)(void*)AL_GPA ("alGetString");
	qalGetBooleanv				= (LPALGETBOOLEANV)(void*)AL_GPA ("alGetBooleanv");
	qalGetIntegerv				= (LPALGETINTEGERV)(void*)AL_GPA ("alGetIntegerv");
	qalGetFloatv				= (LPALGETFLOATV)(void*)AL_GPA ("alGetFloatv");
	qalGetDoublev				= (LPALGETDOUBLEV)(void*)AL_GPA ("alGetDoublev");
	qalGetBoolean				= (LPALGETBOOLEAN)(void*)AL_GPA ("alGetBoolean");
	qalGetInteger				= (LPALGETINTEGER)(void*)AL_GPA ("alGetInteger");
	qalGetFloat					= (LPALGETFLOAT)(void*)AL_GPA ("alGetFloat");
	qalGetDouble				= (LPALGETDOUBLE)(void*)AL_GPA ("alGetDouble");
	qalGetError					= (LPALGETERROR)(void*)AL_GPA ("alGetError");

	qalIsExtensionPresent		= (LPALISEXTENSIONPRESENT)(void*)AL_GPA ("alIsExtensionPresent");
	qalGetProcAddress			= (LPALGETPROCADDRESS)(void*)AL_GPA ("alGetProcAddress");
	qalGetEnumValue				= (LPALGETENUMVALUE)(void*)AL_GPA ("alGetEnumValue");

	qalListenerf				= (LPALLISTENERF)(void*)AL_GPA ("alListenerf");
	qalListener3f				= (LPALLISTENER3F)(void*)AL_GPA ("alListener3f");
	qalListenerfv				= (LPALLISTENERFV)(void*)AL_GPA ("alListenerfv");
	qalListeneri				= (LPALLISTENERI)(void*)AL_GPA ("alListeneri");
	qalListener3i				= (LPALLISTENER3I)(void*)AL_GPA ("alListener3i");
	qalListeneriv				= (LPALLISTENERIV)(void*)AL_GPA ("alListeneriv");
	qalGetListenerf				= (LPALGETLISTENERF)(void*)AL_GPA ("alGetListenerf");
	qalGetListener3f			= (LPALGETLISTENER3F)(void*)AL_GPA ("alGetListener3f");
	qalGetListenerfv			= (LPALGETLISTENERFV)(void*)AL_GPA ("alGetListenerfv");
	qalGetListeneri				= (LPALGETLISTENERI)(void*)AL_GPA ("alGetListeneri");
	qalGetListener3i			= (LPALGETLISTENER3I)(void*)AL_GPA ("alGetListener3i");
	qalGetListeneriv			= (LPALGETLISTENERIV)(void*)AL_GPA ("alGetListeneriv");

	qalGenSources				= (LPALGENSOURCES)(void*)AL_GPA ("alGenSources");
	qalDeleteSources			= (LPALDELETESOURCES)(void*)AL_GPA ("alDeleteSources");
	qalIsSource					= (LPALISSOURCE)(void*)AL_GPA ("alIsSource");
	qalSourcef					= (LPALSOURCEF)(void*)AL_GPA ("alSourcef");
	qalSource3f					= (LPALSOURCE3F)(void*)AL_GPA ("alSource3f");
	qalSourcefv					= (LPALSOURCEFV)(void*)AL_GPA ("alSourcefv");
	qalSourcei					= (LPALSOURCEI)(void*)AL_GPA ("alSourcei");
	qalSource3i					= (LPALSOURCE3I)(void*)AL_GPA ("alSource3i");
	qalSourceiv					= (LPALSOURCEIV)(void*)AL_GPA ("alSourceiv");
	qalGetSourcef				= (LPALGETSOURCEF)(void*)AL_GPA ("alGetSourcef");
	qalGetSource3f				= (LPALGETSOURCE3F)(void*)AL_GPA ("alGetSource3f");
	qalGetSourcefv				= (LPALGETSOURCEFV)(void*)AL_GPA ("alGetSourcefv");
	qalGetSourcei				= (LPALGETSOURCEI)(void*)AL_GPA ("alGetSourcei");
	qalGetSource3i				= (LPALGETSOURCE3I)(void*)AL_GPA ("alGetSource3i");
	qalGetSourceiv				= (LPALGETSOURCEIV)(void*)AL_GPA ("alGetSourceiv");
	qalSourcePlayv				= (LPALSOURCEPLAYV)(void*)AL_GPA ("alSourcePlayv");
	qalSourceStopv				= (LPALSOURCESTOPV)(void*)AL_GPA ("alSourceStopv");
	qalSourceRewindv			= (LPALSOURCEREWINDV)(void*)AL_GPA ("alSourceRewindv");
	qalSourcePausev				= (LPALSOURCEPAUSEV)(void*)AL_GPA ("alSourcePausev");
	qalSourcePlay				= (LPALSOURCEPLAY)(void*)AL_GPA ("alSourcePlay");
	qalSourceStop				= (LPALSOURCESTOP)(void*)AL_GPA ("alSourceStop");
	qalSourceRewind				= (LPALSOURCEREWIND)(void*)AL_GPA ("alSourceRewind");
	qalSourcePause				= (LPALSOURCEPAUSE)(void*)AL_GPA ("alSourcePause");
	qalSourceQueueBuffers		= (LPALSOURCEQUEUEBUFFERS)(void*)AL_GPA ("alSourceQueueBuffers");
	qalSourceUnqueueBuffers		= (LPALSOURCEUNQUEUEBUFFERS)(void*)AL_GPA ("alSourceUnqueueBuffers");

	qalGenBuffers				= (LPALGENBUFFERS)(void*)AL_GPA ("alGenBuffers");
	qalDeleteBuffers			= (LPALDELETEBUFFERS)(void*)AL_GPA ("alDeleteBuffers");
	qalIsBuffer					= (LPALISBUFFER)(void*)AL_GPA ("alIsBuffer");
	qalBufferData				= (LPALBUFFERDATA)(void*)AL_GPA ("alBufferData");
	qalBufferf					= (LPALBUFFERF)(void*)AL_GPA ("alBufferf");
	qalBuffer3f					= (LPALBUFFER3F)(void*)AL_GPA ("alBuffer3f");
	qalBufferfv					= (LPALBUFFERFV)(void*)AL_GPA ("alBufferfv");
	qalBufferi					= (LPALBUFFERI)(void*)AL_GPA ("alBufferi");
	qalBuffer3i					= (LPALBUFFER3I)(void*)AL_GPA ("alBuffer3i");
	qalBufferiv					= (LPALBUFFERIV)(void*)AL_GPA ("alBufferiv");
	qalGetBufferf				= (LPALGETBUFFERF)(void*)AL_GPA ("alGetBufferf");
	qalGetBuffer3f				= (LPALGETBUFFER3F)(void*)AL_GPA ("alGetBuffer3f");
	qalGetBufferfv				= (LPALGETBUFFERFV)(void*)AL_GPA ("alGetBufferfv");
	qalGetBufferi				= (LPALGETBUFFERI)(void*)AL_GPA ("alGetBufferi");
	qalGetBuffer3i				= (LPALGETBUFFER3I)(void*)AL_GPA ("alGetBuffer3i");
	qalGetBufferiv				= (LPALGETBUFFERIV)(void*)AL_GPA ("alGetBufferiv");

	qalDopplerFactor			= (LPALDOPPLERFACTOR)(void*)AL_GPA ("alDopplerFactor");
	qalDopplerVelocity			= (LPALDOPPLERVELOCITY)(void*)AL_GPA ("alDopplerVelocity");
	qalSpeedOfSound				= (LPALSPEEDOFSOUND)(void*)AL_GPA ("alSpeedOfSound");
	qalDistanceModel			= (LPALDISTANCEMODEL)(void*)AL_GPA ("alDistanceModel");

	qalcCreateContext			= (LPALCCREATECONTEXT)(void*)AL_GPA ("alcCreateContext");
	qalcMakeContextCurrent		= (LPALCMAKECONTEXTCURRENT)(void*)AL_GPA ("alcMakeContextCurrent");
	qalcProcessContext			= (LPALCPROCESSCONTEXT)(void*)AL_GPA ("alcProcessContext");
	qalcSuspendContext			= (LPALCSUSPENDCONTEXT)(void*)AL_GPA ("alcSuspendContext");
	qalcDestroyContext			= (LPALCDESTROYCONTEXT)(void*)AL_GPA ("alcDestroyContext");
	qalcGetCurrentContext		= (LPALCGETCURRENTCONTEXT)(void*)AL_GPA ("alcGetCurrentContext");
	qalcGetContextsDevice		= (LPALCGETCONTEXTSDEVICE)(void*)AL_GPA ("alcGetContextsDevice");

	qalcOpenDevice				= (LPALCOPENDEVICE)(void*)AL_GPA ("alcOpenDevice");
	qalcCloseDevice				= (LPALCCLOSEDEVICE)(void*)AL_GPA ("alcCloseDevice");

	qalcGetError				= (LPALCGETERROR)(void*)AL_GPA ("alcGetError");

	qalcIsExtensionPresent		= (LPALCISEXTENSIONPRESENT)(void*)AL_GPA ("alcIsExtensionPresent");
	qalcGetProcAddress			= (LPALCGETPROCADDRESS)(void*)AL_GPA ("alcGetProcAddress");

	qalcGetEnumValue			= (LPALCGETENUMVALUE)(void*)AL_GPA ("alcGetEnumValue");
	qalcGetString				= (LPALCGETSTRING)(void*)AL_GPA ("alcGetString");
	qalcGetIntegerv				= (LPALCGETINTEGERV)(void*)AL_GPA ("alcGetIntegerv");

	qalcCaptureOpenDevice		= (LPALCCAPTUREOPENDEVICE)(void*)AL_GPA ("alcCaptureOpenDevice");
	qalcCaptureCloseDevice		= (LPALCCAPTURECLOSEDEVICE)(void*)AL_GPA ("alcCaptureCloseDevice");
	qalcCaptureStart			= (LPALCCAPTURESTART)(void*)AL_GPA ("alcCaptureStart");
	qalcCaptureStop				= (LPALCCAPTURESTOP)(void*)AL_GPA ("alcCaptureStop");
	qalcCaptureSamples			= (LPALCCAPTURESAMPLES)(void*)AL_GPA ("alcCaptureSamples");
