...
typedef struct gameImport_s {
	...
	qBool	(*inPHS) (vec3_t p1, vec3_t p2);
	void	(*SetAreaPortalState) (int portalNum, qBool open);
	qBool	(*AreasConnected) (int area1, int area2);
	...
	void	(*unicast) (edict_t *ent, qBool reliable);
