...
void Touch_Multi (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if(other->client)
	{
...
void trigger_push_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
...
void hurt_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	int		dflags;
...
void trigger_gravity_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
...
void trigger_monsterjump_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
