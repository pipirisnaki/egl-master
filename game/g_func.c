...
void Touch_Plat_Center (edict_t *ent, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if (!other->client)
		return;
...
void rotating_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
...
void button_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if (!other->client)
		return;
...
void door_use_areaportals (edict_t *self, qBool open)
{
	edict_t	*t = NULL;
...
void Touch_DoorTrigger (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if (other->health <= 0)
		return;
...
void door_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if (!other->client)
		return;
